...
namespace SRLOCSistema
{
    partial class SRLOC
    {
        ...
        private void InitializeComponent()
        {
			...
			this.chkMilimetros = new System.Windows.Forms.CheckBox();
			...
			this.btnGerarTxt.Text = "Copiar para área de transferência (ctrl+c)";
			...
			// txtResultado
			// 
			this.txtResultado.Location = new System.Drawing.Point(676, 44);
			this.txtResultado.Name = "txtResultado";
			this.txtResultado.ReadOnly = true;
			this.txtResultado.Size = new System.Drawing.Size(288, 225);
			this.txtResultado.TabIndex = 42;
			this.txtResultado.Text = "";
			// 
			// chkMilimetros
			// 
			this.chkMilimetros.AutoSize = true;
			this.chkMilimetros.Checked = true;
			this.chkMilimetros.CheckState = System.Windows.Forms.CheckState.Checked;
			this.chkMilimetros.Location = new System.Drawing.Point(764, 21);
			this.chkMilimetros.Name = "chkMilimetros";
			this.chkMilimetros.Size = new System.Drawing.Size(92, 17);
			this.chkMilimetros.TabIndex = 43;
			this.chkMilimetros.Text = "Por milímetros";
			this.chkMilimetros.UseVisualStyleBackColor = true;
			this.chkMilimetros.CheckedChanged += new System.EventHandler(this.chkMilimetros_CheckedChanged);
			// 
			// SRLOC
			// 
			...
			this.Controls.Add(this.chkMilimetros);
		...
		private CheckBox chkMilimetros;
	}
}
