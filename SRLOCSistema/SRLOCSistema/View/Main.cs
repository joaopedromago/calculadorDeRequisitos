...
namespace SRLOCSistema
{
    public partial class SRLOC : Form
    {
        ...
        public void PreencherDadosResultado()
        {
            ...
            using (var reader = ObjectReader.Create(_calculo.ValoresPorComodo,
"Comodo", "Item",
"QuantidadeXComprimento",
"QuantidadeYComprimento",
"RecortesXComprimento",
"RecortesYComprimento",
"QuantidadeXLargura",
"QuantidadeYLargura",
"RecortesXLargura",
"RecortesYLargura"))
            ...
            table.Columns["Comodo"].ColumnName = "Comodo";
            table.Columns["Item"].ColumnName = "Item";
            table.Columns["QuantidadeXComprimento"].ColumnName = "Qtd C. Comodo / L. Item";
            table.Columns["QuantidadeYComprimento"].ColumnName = "Qtd C. Comodo / C. Item";
            table.Columns["RecortesXComprimento"].ColumnName = "Recorte C. Comodo / L. Item";
            table.Columns["RecortesYComprimento"].ColumnName = "Recorte C. Comodo / C. Item";
            table.Columns["QuantidadeXLargura"].ColumnName = "Qtd L. Comodo / L. Item";
            table.Columns["QuantidadeYLargura"].ColumnName = "Qtd L. Comodo / C. Item";
            table.Columns["RecortesXLargura"].ColumnName = "Recorte L. Comodo / L. Item";
            table.Columns["RecortesYLargura"].ColumnName = "Recorte L. Comodo / C. Item";
        ...
        public void atualizarItem()
        {
            ...
            if(item.ValidarCampos(nome, largura, comprimento, larguraEspacamento, comprimentoEspacamento))
            {
